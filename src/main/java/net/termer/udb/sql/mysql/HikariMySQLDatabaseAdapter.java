...
/**
 * Class to setup a Hikari connection pool for a MySQL database and interact with it
 * @author termer
 * @since 1.1
 */
public class HikariMySQLDatabaseAdapter implements SQLDatabaseAdapter {
	 ...
	 * @since 1.0
	 */
	public HikariMySQLDatabaseAdapter(String address, String dbname, String user, String password) {
		// Store values
		_ADDRESS_ = address;
		_DBNAME_ = dbname;
		_USER_ = user;
	 ...
	 * @since 1.0
	 */
	public HikariMySQLDatabaseAdapter(String address, int port, String dbname, String user, String password) {
		// Store values
		_ADDRESS_ = address;
		_PORT_ = port;
		_DBNAME_ = dbname;
	...
	public void connect() throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		...
		_HIKARI_.setDataSourceClassName("com.mysql.jdbc.jdbc2.optional.MysqlDataSource");
